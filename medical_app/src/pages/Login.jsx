...
export default function Login() {
  ...
  function handleSubmit(event) {
    ...
    if (password !== DEMO_PASSWORD) {
      setError('Use the demo password "password123".');
      return;
    }

    setLoading(true);
    localStorage.setItem(AUTH_STORAGE_KEY, role);
    window.setTimeout(() => navigate(ROLE_REDIRECT[role]), 420);
  }
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="login-field">
                <label className="login-label" htmlFor="login-username">Name / Username</label>
                <input
                  id="login-username"
